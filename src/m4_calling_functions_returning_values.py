...
def digits_in_cube(n):
    ...
    ###########################################################################
    # -------------------------------------------------------------------------
    digits_in_cube = sum_of_digits(n ** 3)
    return digits_in_cube
...
def digits_in_power(n, k):
    ...
    ###########################################################################
    # -------------------------------------------------------------------------
    digits_in_power = sum_of_digits(n ** k)
    return digits_in_power
...
def run_test_fancy_sums_of_digits():
    ...
    # Test 2:
    expected =
    answer = fancy_sums_of_digits(39)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    # Test 3:
    expected = 334
    answer = fancy_sums_of_digits(7480)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)
...
def fancy_sums_of_digits(n):
    ...
    fancy_sums_of_digits = sum_of_digits(x ** y)
    return fancy_sums_of_digits
# -----------------------------------------------------------------------------
