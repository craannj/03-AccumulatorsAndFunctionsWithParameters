...
def draw_circles1():
    ...
    for k in range(201):
        if k % 10 == 0:
            circle = rg.Circle(rg.Point(200, 200), k)
...
def draw_circles2():
    ...
    for k in range(40):
        if k % 2 == 1:
            number = k * 10
            if number > 49 and number % 20 > 0:
                circle = rg.Circle(rg.Point(number, 100), 10)
                circle.attach_to(window)
...
def draw_cosines_and_sines():
    ...
    for k in range(101):
        x = 200 + (80 * math.cos(k))
        y = 200 + (80 * math.cos(k))
        circle = rg.Circle(rg.Point(x, y), 10)
        circle.attach_to(window)
