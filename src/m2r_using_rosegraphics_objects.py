...
#                clone, move_by, move_center_to
#
#          -- Write the names of three INSTANCE VARIABLEs that Circle
#             objects have:
#                radius, fill_color, center
#
#     f. What does a RoseWindow RENDER method do?
#            It draws the objects on the window
#
#     g. When is a RoseWindow close_on_mouse_click method call
#        necessary?  Why?
#            When the window needs to stay open. This is necessary because the window will close right after otherwise.
#
